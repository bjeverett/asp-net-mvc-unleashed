...
namespace UnleashedBlog.Tests.Controllers
{
    ...
    public class ArchiveControllerTests
    {
        ...
        public void IndexReturnsBlogEntriesByYear()
        {
            ...
            // Act
            var result = (ViewResult)_archiveController.Index(null, 2010, null, null, null);
        ...
        public void IndexReturnsBlogEntriesByMonth()
        {
            ...
            // Act
            var result = (ViewResult)_archiveController.Index(null, 2010, 12, null, null);
        ...
        public void IndexReturnsBlogEntriesByDay()
        {
            ...
            // Act
            var result = (ViewResult)_archiveController.Index(null, 2010, 12, 25, null);
        ...
        public void IndexReturnsBlogEntryByName()
        {
            ...
            // Act
            var result = (ViewResult)_archiveController.Index(null, null, null, null, "Test-2");
        ...
        {
            // Act
            var result = _archiveController.Index_Ajax(0, 2010, 12, 25, "TheName");
